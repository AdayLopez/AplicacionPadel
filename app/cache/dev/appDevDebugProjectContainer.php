...
class appDevDebugProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            ...
            'padelschedule_user_profile.form.type' => 'getPadelscheduleUserProfile_Form_TypeService',
            'padelschedule_user_registration.form.type' => 'getPadelscheduleUserRegistration_Form_TypeService',
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => 3306, 'dbname' => 'padelSchedule', 'user' => 'root', 'password' => NULL, 'charset' => 'UTF8', 'driverOptions' => array(), 'defaultTableOptions' => array()), $b, $c, array());
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        ...
        $b = new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($a, array(0 => ($this->targetDirs[3].'\\src\\PadelSchedule\\MainBundle\\Entity'), 1 => ($this->targetDirs[3].'\\src\\PadelSchedule\\UserBundle\\Entity')));

        $c = new \Doctrine\Common\Persistence\Mapping\Driver\MappingDriverChain();
        $c->addDriver($b, 'PadelSchedule\\MainBundle\\Entity');
        $c->addDriver($b, 'PadelSchedule\\UserBundle\\Entity');
        ...
        $d->setEntityNamespaces(array('PadelScheduleMainBundle' => 'PadelSchedule\\MainBundle\\Entity', 'PadelScheduleUserBundle' => 'PadelSchedule\\UserBundle\\Entity'));
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_adfd1684a7f8199d33a63d429c00441d75bfcf98879b5bfa416f122179f80e06');
    ...
    {
        return $this->services['fos_js_routing.extractor'] = new \FOS\JsRoutingBundle\Extractor\ExposedRoutesExtractor($this->get('router'), array(), __DIR__, array('FrameworkBundle' => 'Symfony\\Bundle\\FrameworkBundle\\FrameworkBundle', 'SecurityBundle' => 'Symfony\\Bundle\\SecurityBundle\\SecurityBundle', 'TwigBundle' => 'Symfony\\Bundle\\TwigBundle\\TwigBundle', 'MonologBundle' => 'Symfony\\Bundle\\MonologBundle\\MonologBundle', 'SwiftmailerBundle' => 'Symfony\\Bundle\\SwiftmailerBundle\\SwiftmailerBundle', 'AsseticBundle' => 'Symfony\\Bundle\\AsseticBundle\\AsseticBundle', 'DoctrineBundle' => 'Doctrine\\Bundle\\DoctrineBundle\\DoctrineBundle', 'SensioFrameworkExtraBundle' => 'Sensio\\Bundle\\FrameworkExtraBundle\\SensioFrameworkExtraBundle', 'PadelScheduleMainBundle' => 'PadelSchedule\\MainBundle\\PadelScheduleMainBundle', 'FOSUserBundle' => 'FOS\\UserBundle\\FOSUserBundle', 'FOSJsRoutingBundle' => 'FOS\\JsRoutingBundle\\FOSJsRoutingBundle', 'PadelScheduleUserBundle' => 'PadelSchedule\\UserBundle\\PadelScheduleUserBundle', 'StingerMomentJsBundle' => 'Stinger\\MomentJsBundle\\StingerMomentJsBundle', 'AcmeDemoBundle' => 'Acme\\DemoBundle\\AcmeDemoBundle', 'WebProfilerBundle' => 'Symfony\\Bundle\\WebProfilerBundle\\WebProfilerBundle', 'SensioDistributionBundle' => 'Sensio\\Bundle\\DistributionBundle\\SensioDistributionBundle', 'SensioGeneratorBundle' => 'Sensio\\Bundle\\GeneratorBundle\\SensioGeneratorBundle'));
    }
    ...
    {
        return $this->services['fos_user.change_password.form.type'] = new \FOS\UserBundle\Form\Type\ChangePasswordFormType('PadelSchedule\\UserBundle\\Entity\\User');
    }
    ...
    {
        return $this->services['fos_user.profile.form.factory'] = new \FOS\UserBundle\Form\Factory\FormFactory($this->get('form.factory'), 'fos_user_profile_form', 'main_user_profile', array(0 => 'Profile', 1 => 'Default'));
    }
    ...
    {
        return $this->services['fos_user.profile.form.type'] = new \FOS\UserBundle\Form\Type\ProfileFormType('PadelSchedule\\UserBundle\\Entity\\User');
    }
    ...
    {
        return $this->services['fos_user.registration.form.factory'] = new \FOS\UserBundle\Form\Factory\FormFactory($this->get('form.factory'), 'fos_user_registration_form', 'main_user_registration', array(0 => 'Registration', 1 => 'Default'));
    }
    ...
    {
        return $this->services['fos_user.registration.form.type'] = new \FOS\UserBundle\Form\Type\RegistrationFormType('PadelSchedule\\UserBundle\\Entity\\User');
    }
    ...
    {
        return $this->services['fos_user.resetting.form.type'] = new \FOS\UserBundle\Form\Type\ResettingFormType('PadelSchedule\\UserBundle\\Entity\\User');
    }
    ...
    protected function getFosUser_UserManagerService()
    {
        ...
        return $this->services['fos_user.user_manager'] = new \FOS\UserBundle\Doctrine\UserManager($this->get('security.encoder_factory'), $a, $a, $this->get('doctrine')->getManager(NULL), 'PadelSchedule\\UserBundle\\Entity\\User');
    }
    ...
    /**
     * Gets the 'padelschedule_user_profile.form.type' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \PadelSchedule\UserBundle\Form\ProfileType A PadelSchedule\UserBundle\Form\ProfileType instance.
     */
    protected function getPadelscheduleUserProfile_Form_TypeService()
    {
        return $this->services['padelschedule_user_profile.form.type'] = new \PadelSchedule\UserBundle\Form\ProfileType('PadelSchedule\\UserBundle\\Entity\\User');
    }

    /**
     * Gets the 'padelschedule_user_registration.form.type' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \PadelSchedule\UserBundle\Form\RegistrationType A PadelSchedule\UserBundle\Form\RegistrationType instance.
     */
    protected function getPadelscheduleUserRegistration_Form_TypeService()
    {
        return $this->services['padelschedule_user_registration.form.type'] = new \PadelSchedule\UserBundle\Form\RegistrationType('PadelSchedule\\UserBundle\\Entity\\User');
    }
    ...
    protected function getTwigService()
    {
        ...
        $this->services['twig'] = $instance = new \Twig_Environment($this->get('twig.loader'), array('debug' => true, 'strict_variables' => true, 'exception_controller' => 'twig.controller.exception:showAction', 'form_themes' => array(0 => 'form_div_layout.html.twig', 1 => '::forms.html.twig'), 'autoescape' => 'filename', 'cache' => (__DIR__.'/twig'), 'charset' => 'UTF-8', 'paths' => array(), 'date' => array('format' => 'F j, Y H:i', 'interval_format' => '%d days', 'timezone' => NULL), 'number_format' => array('decimals' => 0, 'decimal_point' => '.', 'thousands_separator' => ',')));
        ...
        $instance->addExtension(new \Symfony\Bridge\Twig\Extension\FormExtension(new \Symfony\Bridge\Twig\Form\TwigRenderer(new \Symfony\Bridge\Twig\Form\TwigRendererEngine(array(0 => 'form_div_layout.html.twig', 1 => '::forms.html.twig')), $this->get('security.csrf.token_manager', ContainerInterface::NULL_ON_INVALID_REFERENCE))));
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'\\src\\PadelSchedule\\MainBundle/Resources/views'), 'PadelScheduleMain');
        $instance->addPath(($this->targetDirs[3].'\\vendor\\friendsofsymfony\\user-bundle/Resources/views'), 'FOSUser');
        $instance->addPath(($this->targetDirs[3].'\\src\\PadelSchedule\\UserBundle/Resources/views'), 'PadelScheduleUser');
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'PadelScheduleMainBundle' => 'PadelSchedule\\MainBundle\\PadelScheduleMainBundle',
                'FOSUserBundle' => 'FOS\\UserBundle\\FOSUserBundle',
                'FOSJsRoutingBundle' => 'FOS\\JsRoutingBundle\\FOSJsRoutingBundle',
                'PadelScheduleUserBundle' => 'PadelSchedule\\UserBundle\\PadelScheduleUserBundle',
                'StingerMomentJsBundle' => 'Stinger\\MomentJsBundle\\StingerMomentJsBundle',
            ...
            'fos_user.model.user.class' => 'PadelSchedule\\UserBundle\\Entity\\User',
            'fos_user.profile.form.type' => 'main_user_profile',
            ...
            'fos_user.registration.confirmation.from_email' => array(
                'registration@padelschedule.com' => 'Padel Schedule',
            ),
            'fos_user.registration.confirmation.enabled' => true,
            'fos_user.registration.form.type' => 'main_user_registration',
            ...
            'fos_user.resetting.email.from_email' => array(
                'admin@padelschedule.com' => 'Padel Schedule',
            ),
